        ...
        return (
            <View style={[Styles.Container, { flexDirection: 'column' }]}>
                ...
                <View style={{ flex: 1, width: '100%', alignItems: 'center', justifyContent: 'center' }}>
                    ...
                    <Text style={{ fontFamily: 'OpenSans-SemiBold', fontSize: 20, color: '#000000' }}>Service Booked</Text>
                    <Text style={{ fontFamily: 'OpenSans-Bold', fontSize: 31, color: '#0182C3' }}>Successfully</Text>
                    <Text style={{ fontFamily: 'Roboto-Regular', fontSize: 16, color: '#000000', opacity: .5 }}>Your booking id : 102145121012</Text>
